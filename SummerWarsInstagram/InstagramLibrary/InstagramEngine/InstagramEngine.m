...
static NSString *const kInstagramInfo = @"InstagramInfo";

static NSString *const kInstagramInfoBaseUrlConfigurationKey = @"InstagramInfoBaseUrl";
static NSString *const kInstagramInfoAppClientIdConfigurationKey = @"InstagramInfoAppClientId";

static NSString *const kInstagramInfoAppRedirectUrlConfigurationKey = @"InstagramInfoAppRedirectURL";
static NSString *const kInstagramInfoAuthorizationUrlConfigurationKey = @"InstagramInfoAuthorizationUrl";

static NSString *const kInstagramInfoBaseUrlDefault = @"https://api.instagram.com/v1/";
static NSString *const kInstagramInfoAuthorizationUrlDefault = @"https://api.instagram.com/oauth/authorize/";
static NSString *const kInstagramInfoErrorDomain = @"InstagramKitErrorDomain";


static NSString *const kRelationshipOutgoingStatusKey = @"outgoing_status";
static NSString *const kRelationshipOutStatusFollows = @"follows";
static NSString *const kRelationshipOutStatusRequested = @"requested";
static NSString *const kRelationshipOutStatusNone = @"none";

static NSString *const kRelationshipIncomingStatusKey = @"incoming_status";
static NSString *const kRelationshipInStatusFollowedBy = @"followed_by";
static NSString *const kRelationshipInStatusRequestedBy = @"requested_by";
static NSString *const kRelationshipInStatusBlockedByYou = @"blocked_by_you";
static NSString *const kRelationshipInStatusNone = @"none";

static NSString *const kRelationshipUserIsPrivateKey = @"target_user_is_private";

static NSString *const kRelationshipActionKey = @"action";
static NSString *const kRelationshipActionFollow = @"follow";
static NSString *const kRelationshipActionUnfollow = @"unfollow";
static NSString *const kRelationshipActionBlock = @"block";
static NSString *const kRelationshipActionUnblock = @"unblock";
static NSString *const kRelationshipActionApprove = @"approve";
static NSString *const kRelationshipActionDeny = @"deny";
...
+ (InstagramEngine *)sharedManager {
    static InstagramEngine *sharedInstagramEngineManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        sharedInstagramEngineManager = [[self alloc] init];
    });
    
    return sharedInstagramEngineManager;
}

+ (NSDictionary*)sharedEngineConfiguration {
    NSURL *url = [[NSBundle mainBundle] URLForResource:kInstagramInfo withExtension:@"plist"];
...
- (id)init {
    ...
    if (self) {
        ...
        id url = sharedEngineConfiguration[kInstagramInfoBaseUrlConfigurationKey];
        if (url) {
            url = [NSURL URLWithString:url];
        } else {
            url = [NSURL URLWithString:kInstagramInfoBaseUrlDefault];
        }
        NSAssert(url, @"Base URL not valid: %@", sharedEngineConfiguration[kInstagramInfoBaseUrlConfigurationKey]);
        
        self.operationManager = [[AFHTTPRequestOperationManager alloc] initWithBaseURL:url];
        self.appClientID =  sharedEngineConfiguration[kInstagramInfoAppClientIdConfigurationKey];
        self.appRedirectURL = sharedEngineConfiguration[kInstagramInfoAppRedirectUrlConfigurationKey];
        
        url = sharedEngineConfiguration[kInstagramInfoAuthorizationUrlConfigurationKey];
        self.authorizationURL = (url ? url : kInstagramInfoAuthorizationUrlDefault);
...
- (void)cancelLogin
{
    if (self.instagramLoginBlock)
    {
        ...
        NSError *error = [NSError errorWithDomain:kInstagramInfoErrorDomain code:kInstagramInfoErrorCodeUserCancelled userInfo:@{
         ...
         annotation:(id)annotation
{
    ...
    else if (self.instagramLoginBlock)
    {
        ...
        NSError *error = [NSError errorWithDomain:kInstagramInfoErrorDomain code:kInstagramInfoErrorCodeAccessNotGranted userInfo:@{
                                                                                                                                  NSLocalizedDescriptionKey: localizedDescription
                                                                                                                                  }];
        self.instagramLoginBlock(error);
    }
